...
contents into a new folder here called EMNIST_dataset.

Regardless, though, I would not recommend attempting to set up and run this on your 
own. Just pull the trained model.h5 file from the models folder to use if needed.